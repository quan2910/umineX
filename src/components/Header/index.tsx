      ...
      <header className="fixed lg:block hidden shadow-md bg-white w-full top-0 z-[40]">
        ...
        <div className="py-5 gap-4 2xl:gap-0 flex 2xl:px-0 items-center max-w-[1410px] mx-auto px-4 border-y justify-between border-line">
          ...
          <div className="flex min-w-[270px] items-center">
            <div className="flex p-0 cursor-pointer items-center gap-[10px] mr-[26px]">
            ...
            <div className="relative cursor-pointer p-0 mr-[35px]">
              <Image src={heart} alt="heart" />
              <div className="rounded-full absolute -top-[6px] -right-[6px] bg-red size-[18px] flex items-center justify-center text-white text-10">
                2
              </div>
            </div>
            <div className="flex cursor-pointer items-center p-0 gap-[10px]">
              <CartIcon />
              <div>
